                            ...
                            {assignments.map(assignment => (
                                <React.Fragment key={assignment.id}>
                                    <tr className="bg-white border-b hover:bg-gray-50">
                                        <td className="px-6 py-4 font-medium text-gray-900">{assignment.subject}: {assignment.topic} {assignment.createdBy === 'student' && <span className="text-xs text-gray-500">(Self-Assessed)</span>}</td>
                    ...
                    <table className="w-full text-sm text-left text-gray-500">
                        ...
                        <tbody>
                            {assignments.map(assignment => (
                                <React.Fragment key={assignment.id}>
                                <tr className="bg-white border-b hover:bg-gray-50">
                                    <td className="px-6 py-4 font-medium text-gray-900">{assignment.subject}: {assignment.topic} {assignment.createdBy === 'student' && <span className="text-xs text-purple-500">(Self-Assessed)</span>}</td>
                                    <td className="px-6 py-4">{formatDate(assignment.createdAt)}</td>
                                    <td className="px-6 py-4">{assignment.completedAt ? formatDate(assignment.completedAt) : 'N/A'}</td>
                                ...
                                {assignment.parentComment && (
                                    <tr className="bg-gray-50 border-b">
                                        <td colSpan="6" className="px-6 py-2 text-xs italic text-gray-600">
                                            <b>Parent's Comment:</b> {assignment.parentComment}
                                        </td>
                                    </tr>
                                )}
                                </React.Fragment>
